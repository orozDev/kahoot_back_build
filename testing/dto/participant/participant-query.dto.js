...
exports.ParticipantQueryDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const paginationQueryDto_1 = require("../../../utils/dto/paginationQueryDto");
class ParticipantQueryDto extends paginationQueryDto_1.PaginationQueryDto {
}
__decorate([
...
], ParticipantQueryDto.prototype, "user", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_transformer_1.Transform)(({ obj, key }) => Number(obj[key])),
    __metadata("design:type", Number)
], ParticipantQueryDto.prototype, "testing", void 0);
__decorate([

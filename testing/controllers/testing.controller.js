...
const create_testing_dto_1 = require("../dto/testing/create-testing.dto");
const update_testing_dto_1 = require("../dto/testing/update-testing.dto");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [testing_query_dto_1.TestingQueryDto]),
    __metadata("design:returntype", void 0)
...
TestingController = __decorate([
    ...
    (0, common_1.Controller)('/testings'),

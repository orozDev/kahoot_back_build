...
let QuestionOwnerGuard = class QuestionOwnerGuard extends jwt_auth_guard_1.JwtAuthGuard {
    ...
    async canActivate(context) {
        ...
        const answer_id = +req._parsedUrl.pathname.split('/').at(-1);
        const answer = await this.answerService.findOneForGuard(answer_id);
        console.log(answer.question.quiz.user.id, req.user.id);
        return (((_b = (_a = answer.question) === null || _a === void 0 ? void 0 : _a.quiz) === null || _b === void 0 ? void 0 : _b.user.id) === req.user.id ||

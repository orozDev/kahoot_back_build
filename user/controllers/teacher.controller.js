...
const is_teacher_guard_1 = require("../guards/is-teacher.guard");
let TeacherController = class TeacherController {
    constructor(teacherService) {
        this.teacherService = teacherService;
    }
    createAsAdmin(createTeacherDto) {
        return this.teacherService.create(createTeacherDto);
    }
    create(createTeacherDto, req) {
        return this.teacherService.create(Object.assign(Object.assign({}, createTeacherDto), { user: req.user.id }));
    }
...
], TeacherController.prototype, "createAsAdmin", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, roles_auth_decorator_1.Roles)(user_roles_enum_1.UserRolesEnum.TEACHER),
    (0, common_1.UseGuards)(role_auth_guard_1.RoleAuthGuard),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_teacher_dto_1.UpdateTeacherDto, Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, common_1.UseGuards)(role_auth_guard_1.RoleAuthGuard),
    (0, common_1.UseGuards)(is_teacher_guard_1.IsTeacherGuard),
    (0, common_1.Patch)(':id'),

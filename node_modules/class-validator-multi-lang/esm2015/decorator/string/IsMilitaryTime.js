...
export function IsMilitaryTime(validationOptions) {
    return ValidateBy({
        ...
        validator: {
            ...
            defaultMessage: buildMessage(eachPrefix => eachPrefix + getText('$property must be a valid representation of military time in the format HH:MM'), validationOptions),
        },
    }, validationOptions);
}

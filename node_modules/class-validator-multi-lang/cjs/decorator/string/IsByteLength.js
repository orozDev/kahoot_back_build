...
function IsByteLength(min, max, validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)("$property's byte length must fall into ($constraint1, $constraint2) range"), validationOptions),
        },
    }, validationOptions);
}
exports.IsByteLength = IsByteLength;

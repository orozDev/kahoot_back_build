        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)((eachPrefix, args) => {
                ...
                if (isMinLength && (!args.value || args.value.length < args.constraints[0])) {
                    return eachPrefix + (0, multi_lang_1.getText)('$property must be longer than or equal to $constraint1 characters');
                }
                else if (isMaxLength && args.value.length > args.constraints[1]) {
                    return eachPrefix + (0, multi_lang_1.getText)('$property must be shorter than or equal to $constraint2 characters');
                }
                return (eachPrefix +
                    (0, multi_lang_1.getText)('$property must be longer than or equal to $constraint1 and shorter than or equal to $constraint2 characters'));
            }, validationOptions),
        },
    }, validationOptions);
}

...
function MinLength(min, validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)('$property must be longer than or equal to $constraint1 characters'), validationOptions),
        },
    }, validationOptions);
}
exports.MinLength = MinLength;

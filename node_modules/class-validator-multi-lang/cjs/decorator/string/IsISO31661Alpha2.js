...
function IsISO31661Alpha2(validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)('$property must be a valid ISO31661 Alpha2 code'), validationOptions),
        },
    }, validationOptions);
}
exports.IsISO31661Alpha2 = IsISO31661Alpha2;

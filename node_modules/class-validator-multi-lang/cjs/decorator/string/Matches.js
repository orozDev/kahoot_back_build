...
function Matches(pattern, modifiersOrAnnotationOptions, validationOptions) {
    ...
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)((eachPrefix, args) => eachPrefix + (0, multi_lang_1.getText)('$property must match $constraint1 regular expression'), validationOptions),
        },
    }, validationOptions);
}
exports.Matches = Matches;

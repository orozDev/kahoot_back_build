...
function IsSemVer(validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)('$property must be a Semantic Versioning Specification'), validationOptions),
        },
    }, validationOptions);
}
exports.IsSemVer = IsSemVer;

...
class ValidationExecutor {
    ...
    createValidationError(object, value, metadata, customValidatorMetadata) {
        ...
        if (typeof message === 'string') {
            const messages = (this.validatorOptions && this.validatorOptions.messages) || (0, multi_lang_1.getClassValidatorMessages)();
            Object.keys(messages).forEach(messageKey => {
                const key = (0, multi_lang_1.getText)(messageKey);
                const value = messages[messageKey] || messageKey;
                message = message.split(key).join(value);
            });
        }
        const messageString = ValidationUtils_1.ValidationUtils.replaceMessageSpecialTokens(message, validationArguments, titles);
